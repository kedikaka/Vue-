          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <form class="form-horizontal">
                ...
                <div class="form-group">
                  <label for="input002" class="col-sm-2 control-label form-label">选择图片</label>
                  <div class="col-sm-10" style="width:70%">
  ...
  export default {
    ...
    methods: {
      ...
      upload(item) {
        ...
        param_data.append('resourceType', 3);

        let file = this.$refs.fileData.files[0];
        console.log(file);
        let fileExt = file.type;
        if (this.imgData.accept.indexOf(fileExt) == -1) {
          alert('请选择我们支持的图片格式！');
          return false;
        }
